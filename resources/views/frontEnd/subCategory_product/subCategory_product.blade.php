...
<ul class="list">
    @foreach($categories as $category)
        <li>
            <a href="product-grids.html">{{ $category->category_name }} </a>
        </li>
    @endforeach
</ul>
</div>
        ...
        <div class="single-product">
            ...
            <div class="product-info">
                <div class="d-flex">
                    ...
                    <span class="ms-2 category">{{$product->sub_category->sub_category_name}}</span>
                </div>
                ...
                <div class="price">
                    <span class="text-muted text-decoration-line-through" >{{$product->regular_price}}</span>
                    <span class="fw-bold text-primary ms-2">{{$product->discount_price}}TK</span>
                </div>
            </div>
        </div>
