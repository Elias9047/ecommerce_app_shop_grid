        ...
        <div class="col-lg-10">
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <form class="form-horizontal p-t-20" action="{{  route('store_brand') }}" method="POST"   enctype="multipart/form-data">
                        @csrf
                        ...
                        {{-- Brand Name --}}
                        <div class="form-group row mb-3">
                            <label for="exampleInputuname3" class="col-sm-3 col-form-label">Brand Name <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="" name="brand_name" id="exampleInputuname3" placeholder="Brand Name"/>
                            </div>
                             @error('brand_name')
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="brand_description" id="exampleInputEmail3" placeholder="Brand Description"></textarea>                              
                            </div>
